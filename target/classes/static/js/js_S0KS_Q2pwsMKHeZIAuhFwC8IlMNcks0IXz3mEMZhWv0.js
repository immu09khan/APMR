...
! function(e) {
    "use strict";
    "function" == typeof define && define.amd ? define(["jquery", "../version", "../keycode", "../unique-id", "../widget"], e) : e(jQuery)
}((function(e) {
    "use strict";
    return e.widget("ui.accordion", {
        ...
        _animate: function(e, t, i) {
            ...
            return "number" == typeof l && (n = l), "string" == typeof l && (s = l), s = s || l.easing || c.easing, n = n || l.duration || c.duration, t.length ? e.length ? (a = e.show().outerHeight(), t.animate(this.hideProps, {
                ...
                complete: u,
                step: function(e, i) {
                    i.now = Math.round(e), "height" !== i.prop ? "content-box" === o && (r += i.now) : "content" !== h.options.heightStyle && (i.now = Math.round(a - t.outerHeight() - r), r = 0)
                }
...
! function(t) {
    "use strict";
    "function" == typeof define && define.amd ? define(["jquery", "../keycode", "../safe-active-element", "../unique-id", "../version", "../widget"], t) : t(jQuery)
}((function(t) {
    "use strict";
    var e;
    return t.widget("ui.tabs", {
        ...
        _findNextTab: function(e, i) {
            ...
            for (; - 1 !== t.inArray((e > a && (e = 0), e < 0 && (e = a), e), this.options.disabled);) e = i ? e + 1 : e - 1;
            return e
        },
        ...
        _processTabs: function() {
            ...
            this.tablist = this._getList().attr("role", "tablist"), this._addClass(this.tablist, "ui-tabs-nav", "ui-helper-reset ui-helper-clearfix ui-widget-header"), this.tablist.on("mousedown" + this.eventNamespace, "> li", (function(e) {
                ...
                tabIndex: -1
            }), this._addClass(this.anchors, "ui-tabs-anchor"), this.panels = t(), this.anchors.each((function(i, a) {
                var s, n, h, r = t(a).uniqueId().attr("id"),
                    o = t(a).closest("li"),
                    l = o.attr("aria-controls");
                e._isLocal(a) ? (h = (s = a.hash).substring(1), n = e.element.find(e._sanitizeSelector(s))) : (s = "#" + (h = o.attr("aria-controls") || t({}).uniqueId()[0].id), (n = e.element.find(s)).length || (n = e._createPanel(h)).insertAfter(e.panels[i - 1] || e.tablist), n.attr("aria-live", "polite")), n.length && (e.panels = e.panels.add(n)), l && o.data("ui-tabs-aria-controls", l), o.attr({
                    "aria-controls": h,
                    "aria-labelledby": r
        ...
        _setOptionDisabled: function(e) {
            var i, a, s;
            for (Array.isArray(e) && (e.length ? e.length === this.anchors.length && (e = !0) : e = !1), s = 0; a = this.tabs[s]; s++) i = t(a), !0 === e || -1 !== t.inArray(s, e) ? (i.attr("aria-disabled", "true"), this._addClass(i, null, "ui-state-disabled")) : (i.removeAttr("aria-disabled"), this._removeClass(i, null, "ui-state-disabled"));
        ...
        _eventHandler: function(e) {
            var i = this.options,
                ...
                n = s[0] === a[0],
                h = n && i.collapsible,
                r = h ? t() : this._getPanelForTab(s),
                o = a.length ? this._getPanelForTab(a) : t(),
                l = {
                    oldTab: a,
                    oldPanel: o,
                    newTab: h ? t() : s,
            ...
            e.preventDefault(), s.hasClass("ui-state-disabled") || s.hasClass("ui-tabs-loading") || this.running || n && !i.collapsible || !1 === this._trigger("beforeActivate", e, l) || (i.active = !h && this.tabs.index(s), this.active = n ? t() : s, this.xhr && this.xhr.abort(), o.length || r.length || t.error("jQuery UI Tabs: Mismatching fragment identifier."), r.length && this.load(this.tabs.index(s), e), this._toggle(e, l))
        },
        _toggle: function(e, i) {
            ...
            function r() {
                a._addClass(i.newTab.closest("li"), "ui-tabs-active", "ui-state-active"), s.length && a.options.show ? a._show(s, a.options.show, h) : (s.show(), h())
            }
            this.running = !0, n.length && this.options.hide ? this._hide(n, this.options.hide, (function() {
                a._removeClass(i.oldTab.closest("li"), "ui-tabs-active", "ui-state-active"), r()
            })) : (this._removeClass(i.oldTab.closest("li"), "ui-tabs-active", "ui-state-active"), n.hide(), r()), n.attr("aria-hidden", "true"), i.oldTab.attr({
                "aria-selected": "false",
                "aria-expanded": "false"
            }), s.length && n.length ? i.oldTab.attr("tabIndex", -1) : s.length && this.tabs.filter((function() {
        ...
        load: function(e, i) {
            ...
            var a = this,
                ...
                h = this._getPanelForTab(s),
                r = {
                    tab: s,
                    panel: h
                },
                o = function(t, e) {
                    "abort" === e && a.panels.stop(!1, !0), a._removeClass(s, "ui-tabs-loading"), h.removeAttr("aria-busy"), t === a.xhr && delete a.xhr
                };
            this._isLocal(n[0]) || (this.xhr = t.ajax(this._ajaxSettings(n, i, r)), this.xhr && "canceled" !== this.xhr.statusText && (this._addClass(s, "ui-tabs-loading"), h.attr("aria-busy", "true"), this.xhr.done((function(t, e, s) {
                setTimeout((function() {
                    h.html(t), a._trigger("load", i, r), o(s, e)
                }), 1)
            })).fail((function(t, e) {
                setTimeout((function() {
                    o(t, e)
...
if ((window.location.hostname.indexOf(".gov")) >= 0) {
    var srcUrl = "";
    if (window.env == "production") var srcUrl = "//gateway.foresee.com/sites/sec-gov/production/gateway.min.js";
    else var srcUrl = "//gateway.foresee.com/sites/sec-gov/staging/gateway.min.js";;;
    (function(g) {
        var d = document,
